...
using UpSkillzInject.Services;
using UpSkillzInject.Utilities;

namespace UpSkillzInject
{
    public static partial class Xtenxion
    {
        ...
        public static bool IsIn(this string search_val, string search_list)
        {
            var x = false;
            ...
            if (search_list != null && search_val != null)
            {
                ...
                if (spp != null)
                {
                    return search_list.ToLower().Contains(search_val.ToLower()) || spp.Any(y => y.ToLower().Contains(search_val.ToLower(), StringComparison.InvariantCultureIgnoreCase));
                }
            }
        ...
        public static bool EqualTo(this object value, object compare_value)
        {
            try
            {
                if (value != null && compare_value != null)
                {
                    return value.ToString().Equals(compare_value.ToString(), StringComparison.InvariantCultureIgnoreCase);
                }
                else
                {
        ...
        static Boolean IsDate_2(this Object value, DateTimeFormatInfo formatInfo)
        {
        ...
        public static bool IsDate_3(this object sdate)
        {
            DateTime dt;
            bool isDate = true;
        ...
        public static List<string> FormFilesToBase64List(this List<IFormFile> files)
        {
            try
            {
                ...
                foreach (var file in files)
                {
                    ...
                    throw new Exception($"One of the files '{file.FileName}' is empty!");
                }
        ...
        public static List<byte[]> FormFilesToByteList(this List<IFormFile> files)
        {
            try
            {
        ...
        public static bool IsEnum<T>(this object value)
        {
            try
            {
                var bb = Enum.IsDefined(typeof(T), value);
                return true;
            }
            catch (Exception ex)
            {
