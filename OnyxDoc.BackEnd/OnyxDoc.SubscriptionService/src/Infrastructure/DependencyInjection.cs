...
using OnyxDoc.SubscriptionService.Infrastructure.Services;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.IdentityModel.Tokens;
using OnyxDoc.SubscriptionService.Infrastructure.Contract;
using System.Text;
...
namespace OnyxDoc.SubscriptionService.Infrastructure
{
        ...
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            if (configuration.GetValue<bool>("UseInMemoryDatabase"))
            {
                services.AddDbContext<ApplicationDbContext>(options =>
                    options.UseInMemoryDatabase("OnyxDoc.SubscriptionServiceDb"));
            }
            else
            {
                services.AddDbContext<ApplicationDbContext>(options =>
          ...
          // services.AddTransient<IIdentityService, IdentityService>();
            ...
            services.AddTransient<IPaystackPriceService, PaystackService>();
            services.AddTransient<IPaystackCustomerService, PaystackService>();
            services.AddTransient<IPaystackProductService, PaystackService>();
            services.AddTransient<IPaystackPriceService, PaystackService>();
            services.AddTransient<IPaystackSubscriptionService, PaystackService>();

            services.AddTransient<IStripeService, StripeService>();
            services.AddTransient<IStripePriceService, StripeService>();
            services.AddTransient<IStripeCustomerService, StripeService>();
            services.AddTransient<IStripeProductService, StripeService>();
            services.AddTransient<IStripePriceService, StripeService>();
            services.AddTransient<IStripeSubscriptionService, StripeService>();
