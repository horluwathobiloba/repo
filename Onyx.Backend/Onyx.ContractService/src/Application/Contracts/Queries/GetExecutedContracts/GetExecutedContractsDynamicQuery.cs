...
{
    public class GetExecutedContractsDynamicQuery : AuthToken, IRequest<Result>
    {
    ...
    public class GetExecutedContractsDynamicQueryHandler : IRequestHandler<GetExecutedContractsDynamicQuery, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;
        private readonly IAuthService _authService;

        public GetExecutedContractsDynamicQueryHandler(IApplicationDbContext context, IMapper mapper, IAuthService authService)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<Result> Handle(GetExecutedContractsDynamicQuery request, CancellationToken cancellationToken)
        {
            try
            {
                var respo = await _authService.ValidateOrganisationData(request.AccessToken, request.OrganisationId);

                //please check this query again
