using RubyReloaded.SubscriptionService.Domain.Exceptions;
using RubyReloaded.SubscriptionService.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace RubyReloaded.SubscriptionService.Domain.UnitTests.ValueObjects
{
