...
{
    public class ActivatePGPriceCommand : AuthToken, IRequest<Result>
    {
    ...
    public class ActivatePGPriceCommandHandler : IRequestHandler<ActivatePGPriceCommand, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;
        private readonly IAuthService _authService;

        public ActivatePGPriceCommandHandler(IApplicationDbContext context, IMapper mapper, IAuthService authService)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<Result> Handle(ActivatePGPriceCommand request, CancellationToken cancellationToken)
        {
            try
            {
