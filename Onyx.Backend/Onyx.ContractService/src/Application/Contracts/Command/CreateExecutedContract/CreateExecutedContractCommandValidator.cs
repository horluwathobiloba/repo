...
{
    public class CreateExecutedContractCommandValidator : AbstractValidator<CreateExecutedContractCommand>
    {
        public CreateExecutedContractCommandValidator()
        {
            ...
            //made all these fields non-compulsory
