...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class EnglishInflector : IInflector
    {
        ...
        /// </summary>
        /// <example>
        ///     inflect.Pascalise("customer").ShouldBe("User");
        ///     inflect.Pascalise("customer_name").ShouldBe("UserName");
        ///     inflect.Pascalise("customer name").ShouldBe("User name");
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///     inflect.Camelise("User").ShouldBe("customer");
