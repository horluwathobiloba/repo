...
{
    public class UpdateControlPropertiesCommandValidator : AbstractValidator<UpdateControlPropertiesCommand>
    {
        public UpdateControlPropertiesCommandValidator()
        {
    ...
    public class UpdateControlPropertyRequestValidator : AbstractValidator<UpdateControlPropertyRequest>
    {
        public UpdateControlPropertyRequestValidator()
        {
            RuleFor(v => v.SubscriberId).GreaterThan(0).WithMessage("Subscriber must be specified!");
