...
using OnyxDoc.FormBuilderService.API.Filters;
using OnyxDoc.FormBuilderService.API.Services;
using OnyxDoc.FormBuilderService.Application;
using OnyxDoc.FormBuilderService.Application.Common.Interfaces;
using OnyxDoc.FormBuilderService.Infrastructure;
...
namespace API
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    configure.Title = "OnyxDoc.FormBuilderService API";
