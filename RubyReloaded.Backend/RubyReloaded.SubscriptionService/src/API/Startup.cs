...
using RubyReloaded.SubscriptionService.API.Filters;
using RubyReloaded.SubscriptionService.API.Services;
using RubyReloaded.SubscriptionService.Application;
using RubyReloaded.SubscriptionService.Application.Common.Interfaces;
using RubyReloaded.SubscriptionService.Infrastructure;
...
namespace API
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    configure.Title = "RubyReloaded.SubscriptionService API";
