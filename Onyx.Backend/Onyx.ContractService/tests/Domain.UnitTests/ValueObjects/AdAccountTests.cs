using Onyx.ContractService.Domain.Exceptions;
using Onyx.ContractService.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace Onyx.ContractService.Domain.UnitTests.ValueObjects
{
