...
{
    public class FolderDto : IMapFrom<Domain.Entities.Folder>
    {
        ...
        {
            profile.CreateMap<Domain.Entities.Folder, FolderDto>();
            profile.CreateMap<FolderDto, Domain.Entities.Folder>();
        }
    }
}
