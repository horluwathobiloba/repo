...
{
    public class GetSupportingDocumentsQuery : AuthToken, IRequest<Result>
    {
        public int OrganisationId { get; set; }
    }

    public class GetSupportingDocumentsQueryHandler : IRequestHandler<GetSupportingDocumentsQuery, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;
        private readonly IAuthService _authService;

        public GetSupportingDocumentsQueryHandler(IApplicationDbContext context, IMapper mapper, IAuthService authService)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<Result> Handle(GetSupportingDocumentsQuery request, CancellationToken cancellationToken)
        {
            try
            {
