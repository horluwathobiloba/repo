...
{
    public class GetDistinctControllerName : AuthToken, IRequest<Result>
    {
    ...
    public class GetDistinctControllerNameHandler : IRequestHandler<GetDistinctControllerName, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;

        public GetDistinctControllerNameHandler(IApplicationDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }

        public async Task<Result> Handle(GetDistinctControllerName request, CancellationToken cancellationToken)
        {
            try
            {
