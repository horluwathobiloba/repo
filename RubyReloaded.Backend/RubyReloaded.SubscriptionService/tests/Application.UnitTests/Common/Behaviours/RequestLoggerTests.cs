using RubyReloaded.SubscriptionService.Application.Common.Behaviours;
...
namespace RubyReloaded.SubscriptionService.Application.UnitTests.Common.Behaviours
{
