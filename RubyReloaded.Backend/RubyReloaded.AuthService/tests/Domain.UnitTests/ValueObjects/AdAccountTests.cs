using RubyReloaded.AuthService.Domain.Exceptions;
using RubyReloaded.AuthService.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace RubyReloaded.AuthService.Domain.UnitTests.ValueObjects
{
