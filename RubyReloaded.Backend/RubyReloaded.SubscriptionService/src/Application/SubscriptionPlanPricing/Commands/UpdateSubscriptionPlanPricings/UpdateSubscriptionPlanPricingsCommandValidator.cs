...
namespace RubyReloaded.SubscriptionService.Application.SubscriptionPlanPricings.Commands
{
    ...
    public class UpdateSubscriptionCurrencyRequestValidator : AbstractValidator<UpdateSubscriptionPlanPricingRequest>
    {
        public UpdateSubscriptionCurrencyRequestValidator()
        {
