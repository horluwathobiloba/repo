...
{
    public class GetAllExecutedContractsQuery : AuthToken, IRequest<Result>
    {
        public int OrganisationId { get; set; }
    }
    public class GetAllExecutedContractsQueryHandler : IRequestHandler<GetAllExecutedContractsQuery, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;
        private readonly IAuthService _authService;

        public GetAllExecutedContractsQueryHandler(IApplicationDbContext context, IMapper mapper, IAuthService authService)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<Result> Handle(GetAllExecutedContractsQuery request, CancellationToken cancellationToken)
        {
            try
            {
