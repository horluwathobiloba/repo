...
using RubyReloaded.WalletService.Infrastructure.Services;
...
namespace RubyReloaded.WalletService.Infrastructure
{
        ...
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            if (configuration.GetValue<bool>("UseInMemoryDatabase"))
            {
                services.AddDbContext<ApplicationDbContext>(options =>
                    options.UseInMemoryDatabase("OnyxRevamped.DocumentServiceDb"));
            }
            else
            {
                services.AddDbContext<ApplicationDbContext>(options =>
          ...
          // services.AddTransient<IIdentityService, IdentityService>();
           ...
           // services.AddTransient<IAuthService, AuthService>();
            ...
            services.AddTransient<IProvidusBankService, ProvidusBankService>();
