using RubyReloaded.WalletService.Domain.Exceptions;
using RubyReloaded.WalletService.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace RubyReloaded.WalletService.Domain.UnitTests.ValueObjects
{
