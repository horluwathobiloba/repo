...
{
    public class UpdateDocumentPagesCommandValidator : AbstractValidator<UpdateDocumentPagesCommand>
    {
        public UpdateDocumentPagesCommandValidator()
        {
    ...
    public class UpdateDocumentPageRequestValidator : AbstractValidator<UpdateDocumentPageRequest>
    {
        public UpdateDocumentPageRequestValidator()
        {            
