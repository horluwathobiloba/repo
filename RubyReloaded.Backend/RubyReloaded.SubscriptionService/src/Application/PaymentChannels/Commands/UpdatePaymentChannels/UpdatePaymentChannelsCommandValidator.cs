...
{
    public class UpdatePaymentChannelsCommandValidator : AbstractValidator<UpdatePaymentChannelsCommand>
    {
        public UpdatePaymentChannelsCommandValidator()
        {
    ...
    public class UpdatePaymentChannelRequestValidator : AbstractValidator<UpdatePaymentChannelRequest>
    {
        public UpdatePaymentChannelRequestValidator()
        {
