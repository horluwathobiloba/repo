...
namespace OnyxDoc.SubscriptionService.Infrastructure.Persistence
{
    public class ApplicationDbContext : DbContext, IApplicationDbContext
    {
        ...
        public DbSet<FlutterwavePaymentPlan> FlutterwavePaymentPlans { get; set; }
        public DbSet<Payment> Payments { get; set; } 
        public DbSet<StripePaymentResponse> PaymentResponses { get; set; }

        public DbSet<PGPrice> PGPrices { get; set; }
        public DbSet<PGCustomer> PGCustomers { get; set; }
        public DbSet<PGProduct> PGProducts { get; set; }
        public DbSet<PGSubscription> PGSubscriptions { get; set; }
        public DbSet<PGPlan> PGPlans { get; set; }
