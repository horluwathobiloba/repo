...
{
    public class GetPermitTypesQuery : AuthToken, IRequest<Result>
    {
        public int OrganisationId { get; set; }
    }

    public class GetPermitTypesQueryHandler : IRequestHandler<GetPermitTypesQuery, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;
        private readonly IAuthService _authService;

        public GetPermitTypesQueryHandler(IApplicationDbContext context, IMapper mapper, IAuthService authService)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<Result> Handle(GetPermitTypesQuery request, CancellationToken cancellationToken)
        {
            try
            {
