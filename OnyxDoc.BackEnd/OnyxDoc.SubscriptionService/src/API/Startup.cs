...
using OnyxDoc.SubscriptionService.API.Filters;
using OnyxDoc.SubscriptionService.API.Services;
using OnyxDoc.SubscriptionService.Application;
using OnyxDoc.SubscriptionService.Application.Common.Interfaces;
using OnyxDoc.SubscriptionService.Infrastructure;
...
namespace API
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    configure.Title = "OnyxDoc.SubscriptionService API";
