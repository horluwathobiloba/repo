using OnyxDoc.SubscriptionService.Domain.Exceptions;
using OnyxDoc.SubscriptionService.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace OnyxDoc.SubscriptionService.Domain.UnitTests.ValueObjects
{
