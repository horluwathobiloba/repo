...
{
    public class TransactionListDto : IMapFrom<Domain.Entities.Transaction>
{
        ...
        {
            profile.CreateMap<Domain.Entities.Transaction, TransactionListDto> ();
            profile.CreateMap<TransactionListDto, Domain.Entities.Transaction>();
        }
    }
}
