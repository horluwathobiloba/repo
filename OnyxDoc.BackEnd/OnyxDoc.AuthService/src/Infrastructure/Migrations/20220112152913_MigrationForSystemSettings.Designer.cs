...
namespace OnyxDoc.AuthService.Infrastructure.Migrations
{
    ...
    [Migration("20220112152913_MigrationForSystemSettings")]
    partial class MigrationForSystemSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnyxDoc.AuthService.Domain.Entities.AuditTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnyxDoc.AuthService.Domain.Entities.Branding", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("FooterInformation")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("HasFooterInformation")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("OnyxDoc.AuthService.Domain.Entities.DefaultRolesConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DefaultRolesConfigurations");
                });

            modelBuilder.Entity("OnyxDoc.AuthService.Domain.Entities.ExpiryPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ExpirationReminderInterval")
                        .HasColumnType("int");

                    b.Property<int>("ExpirationSettingsFrequency")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnyxDoc.AuthService.Domain.Entities.Feature", b =>
                {
                    ...
                    b.Property<bool>("ShouldShowOnNavBar")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("OnyxDoc.AuthService.Domain.Entities.SystemSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("DocumentExpirationPeriod")
                        .HasColumnType("int");

                    b.Property<int>("ExpirationSettingsFrequency")
                        .HasColumnType("int");

                    b.Property<string>("ExpirationSettingsFrequencyDesc")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("ShouldSentDocumentsExpire")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("WorkflowReminder")
                        .HasColumnType("int");

                    b.Property<int>("WorkflowReminderSettingsFrequency")
                        .HasColumnType("int");

                    b.Property<string>("WorkflowReminderSettingsFrequencyDesc")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnyxDoc.AuthService.Domain.Entities.ExpiryPeriod", b =>
                {
                    b.HasOne("OnyxDoc.AuthService.Domain.Entities.SystemSetting", null)
                        .WithMany("ExpirationReminder")
            ...
            modelBuilder.Entity("OnyxDoc.AuthService.Domain.Entities.SystemSetting", b =>
                {
                    b.Navigation("ExpirationReminder");
                });
