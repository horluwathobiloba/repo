...
{
    public class GetContractTypeInitiatorSummaryQuery : IRequest<Result>
    {
        public int OrganisationId { get; set; }
    }

    public class GetContractTypeInitiatorSummaryQueryHandler : IRequestHandler<GetContractTypeInitiatorSummaryQuery, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;
        public GetContractTypeInitiatorSummaryQueryHandler(IApplicationDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }

        public async Task<Result> Handle(GetContractTypeInitiatorSummaryQuery request, CancellationToken cancellationToken)
        {
