...
namespace OnyxDocSubscription.WindowsService
{
    public partial class SubscriptionService : ServiceBase
    {
        ...
        private string _logFileLocation = @"C:\OnyxDocLogs\SubscriptionServiceLog" + DateTime.Now.Date.ToString("yyyy_MM_dd") + ".txt";
        ...
        private static void OnTimedEvent(object source, ElapsedEventArgs e)
        {
            ...
            subscriptionService.Log("*******Starting OnyxDoc Subscription  Windows Service*******");
        }
