using Onyx.WorkFlowService.Domain.Exceptions;
using Onyx.WorkFlowService.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace Onyx.WorkFlowService.Domain.UnitTests.ValueObjects
{
