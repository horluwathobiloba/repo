...
using RubyReloaded.SubscriptionService.Infrastructure.Identity;
using RubyReloaded.SubscriptionService.Infrastructure.Persistence;
using RubyReloaded.SubscriptionService.Infrastructure.Services;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.IdentityModel.Tokens;
using RubyReloaded.SubscriptionService.Infrastructure.Contract;
using System.Text;
...
namespace RubyReloaded.SubscriptionService.Infrastructure
{
        ...
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            if (configuration.GetValue<bool>("UseInMemoryDatabase"))
            {
                services.AddDbContext<ApplicationDbContext>(options =>
                    options.UseInMemoryDatabase("RubyReloaded.SubscriptionServiceDb"));
            }
            else
            {
                services.AddDbContext<ApplicationDbContext>(options =>
