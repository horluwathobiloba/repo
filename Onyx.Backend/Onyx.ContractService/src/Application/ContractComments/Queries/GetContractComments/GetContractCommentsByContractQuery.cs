...
{
    public class GetContractCommentsByContractQuery : AuthToken, IRequest<Result>
    {
    ...
    public class GetContractCommentsByContractQueryHandler : IRequestHandler<GetContractCommentsByContractQuery, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IAuthService _authService;
        public GetContractCommentsByContractQueryHandler(IApplicationDbContext context, IAuthService authService)
        {
            _context = context;
            _authService = authService;
        }
        public async Task<Result> Handle(GetContractCommentsByContractQuery request, CancellationToken cancellationToken)
        {
            try
            {
