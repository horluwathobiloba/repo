...
{
    public class GetPGProductsQuery : AuthToken, IRequest<Result>
    {
        public int SubscriberId { get; set; }
        public string UserId { get; set; }
    }

    public class GetPGProductsQueryHandler : IRequestHandler<GetPGProductsQuery, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;
        private readonly IAuthService _authService;

        public GetPGProductsQueryHandler(IApplicationDbContext context, IMapper mapper, IAuthService authService)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<Result> Handle(GetPGProductsQuery request, CancellationToken cancellationToken)
        {
            try
            {
