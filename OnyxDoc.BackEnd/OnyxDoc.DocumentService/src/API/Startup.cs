...
using OnyxDoc.DocumentService.API.Filters;
using OnyxDoc.DocumentService.API.Services;
using OnyxDoc.DocumentService.Application;
using OnyxDoc.DocumentService.Application.Common.Interfaces;
using OnyxDoc.DocumentService.Infrastructure;
...
namespace API
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    configure.Title = "OnyxDoc.DocumentService API";
