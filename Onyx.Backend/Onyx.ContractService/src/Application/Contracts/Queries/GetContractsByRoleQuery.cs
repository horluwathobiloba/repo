...
{
    public class GetContractsByRoleQuery : IRequest<Result>
    {
    ...
    public class GetContractsByRoleQueryHandler : IRequestHandler<GetContractsByRoleQuery, Result>
    {
        private readonly IApplicationDbContext _context;
        private readonly IMapper _mapper;

        public GetContractsByRoleQueryHandler(IApplicationDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }

        public async Task<Result> Handle(GetContractsByRoleQuery request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                && a.RoleId == request.RoleId && (!a.IsAnExecutedDocument))
                    .Include(a => a.Vendor) 
